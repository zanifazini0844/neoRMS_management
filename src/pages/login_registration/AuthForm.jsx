      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-10 rounded-xl border border-[#C3110C] focus-visible:ring-2 focus-visible:ring-[#E6501B] focus-visible:border-[#E6501B] focus-visible:ring-offset-1"
            placeholder="••••••••"
          />
          <button
            type="button"
